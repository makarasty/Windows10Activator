...
cscript //nologo c:\windows\system32\slmgr.vbs /ato | find /i "YES" && (echo.& echo ************************************ & echo. & choice /n /c YN /m "restart your PC now [Y,N]?" & if errorlevel 2 exit) || (echo LOADING... & echo Please wait... & echo. & echo. & set /a i+=1 & goto server)
shutdown.exe /r /t 00